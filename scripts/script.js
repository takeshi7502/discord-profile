const userID = "648036769769717760"; // Change this to your Discord user ID
...
async function fetchDiscordStatus() {
	try {
		...
		switch (discord_status) {
			case "online":
				imagePath = "./data/status/online.svg";
				break;
			case "idle":
				imagePath = "./data/status/idle.svg";
				break;
			case "dnd":
				imagePath = "./data/status/dnd.svg";
				break;
			case "offline":
				imagePath = "./data/status/offline.svg";
				break;
			default:
				imagePath = "./data/status/offline.svg";
				break;
		...
		if (
			...
			imagePath = "./data/status/streaming.svg";
		}
